...
public class PaymentServiceTests {
    ...
    public void saveFailurePayment() {
        ...
        service.send(new OrderPurchase(orderId, customerId, 102, 1002, 2, 2400, "ORDER_PAID", "WALLET", Instant.now()));
    ...
    public void getByOrderId(){
        ...
        when(repo.findByorderId(orderId)).thenReturn(Payment.of(id, orderId, 20, 101, 1001, 2, 240, "WALLET", PaymentStatus.SUCCESS.toString()));

        assertEquals(240,service.findBYOrderID(orderId).getAmount());
    }
}

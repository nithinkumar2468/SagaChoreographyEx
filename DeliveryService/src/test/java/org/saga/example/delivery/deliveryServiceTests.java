...
public class deliveryServiceTests {
    ...
    public void saveDelivery() throws InterruptedException {
        ...
        when(repo.findAll()).thenReturn(Stream.of(new Delivery(id,orderId,20,"DOSA","UDUPI",2,"SUCCESS", Instant.now()),new Delivery(UUID.randomUUID(),UUID.randomUUID(),24,"Biryani","MEGHNA",2,"SUCCESS",Instant.now())).collect(Collectors.toList()));
